...
def get_year(year_text):
    ...
    if yearange2:
        return 2    #so 2 means that two dates were given as alternatives, or range. You might chose to examine and replace those manually
    elif yearange:
        return 3    #3 means a range of years were given in the form dddd-dd
    elif yearquest:
        return 0    #0 is when the date was marked with a question mark
    elif match:
        return int(match.group())
    else: 	
        return 4   #other forms of unclear markings
